#!/bin/bash -eu
# Download scc*.html.gz files listed at https://tenhou.net/sc/raw/list.cgi?old
#
# Usage:
# Create a download folder and run this script.
#
# (For files prior to 2024, you can download the same files from the official URL below.)
# http://tenhou.net/sc/raw/scraw2024.zip
